 ...
 G4Tubs* worldSolid = new G4Tubs("World_Solid", 0*m, world_Radius, world_halfHeight, 0*deg, 360*deg);
   ...
   */
    ...
    //--------------------------------------------------------------------------------------------   
     ...
     const G4double                  EJ4_Radius = 1.*2.54*cm;
    ...
    G4Tubs*                        EJ4_tube = new G4Tubs("EJ4_tube", 0.*cm, EJ4_Radius, EJ4_Radius, 0.*deg, 360.*deg);
    ...
    G4double EJ4Center_PositionX = TMath::Cos(Dip_Angle)*TMath::Cos(EJ4_Scatter_Angle)*(TPC_EJ_Distance + EJ4_Radius);
    G4double EJ4Center_PositionY = -TMath::Sin(EJ4_Scatter_Angle)*(TPC_EJ_Distance + EJ4_Radius);
    G4double EJ4Center_PositionZ = -TMath::Sin(Dip_Angle)*TMath::Cos(EJ4_Scatter_Angle)*(TPC_EJ_Distance + EJ4_Radius)+TPC_Center_zAxis_Offset;
    ...
    double EJ4_Theta = TMath::ASin(-SideEJ301Center_PositionZ/TMath::Sqrt(TMath::Power(SideEJ301Center_PositionX, 2)+TMath::Power(SideEJ301Center_PositionY, 2) ) ); //---- the angle between line and xyPlane ----
    double   EJ4_Phi = TMath::ATan(SideEJ301Center_PositionY/SideEJ301Center_PositionX);//---- projected line, the angle to the xAxis -----
