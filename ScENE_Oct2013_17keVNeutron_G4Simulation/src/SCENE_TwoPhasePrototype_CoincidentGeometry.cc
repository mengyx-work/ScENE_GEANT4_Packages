 ...
 G4Tubs* worldSolid = new G4Tubs("World_Solid", 0*m, world_Radius, world_halfHeight, 0*deg, 360*deg);
   ...
   */
    ...
    //--------------------------------------------------------------------------------------------   
     ...
     const G4double              EJ4_halfHeight = 1.*2.54*cm;
     ...
     const G4double             TPC_EJ_Distance = 28*2.54*cm;    //----- from TPC center to the front end of EJs ------
     const G4double            TPC_EJ4_Distance = 30.5*2.54*cm;    //----- from TPC center to the front end of EJs ------
    
  

    G4Tubs*                         EJ_tube = new G4Tubs("EJ_tube", 0.*cm, EJ_Radius, EJ_halfHeight, 0.*deg, 360.*deg);
    G4Tubs*                        EJ4_tube = new G4Tubs("EJ4_tube", 0.*cm, EJ_Radius, EJ4_halfHeight, 0.*deg, 360.*deg);
    
    G4LogicalVolume*        EJ_tube_Logical = new G4LogicalVolume(EJ_tube, EJ301,   "EJ_tube_Logical");
    G4LogicalVolume*       EJ4_tube_Logical = new G4LogicalVolume(EJ4_tube, EJ301, "EJ4_tube_Logical");
    
    EJ_tube_Logical->SetVisAttributes(G4Colour::Red());
    EJ4_tube_Logical->SetVisAttributes(G4Colour::Red());

    
    G4RotationMatrix R_EJ1, R_EJ2, R_EJ3, R_EJ4;
    G4ThreeVector    T_EJ1, T_EJ2, T_EJ3, T_EJ4;
    

    const double              Dip_Angle = 35.56/180.*TMath::Pi();
    const double          Scatter_Angle = 69.7/180*TMath::Pi();
    const double      EJ4_Scatter_Angle = 45./180*TMath::Pi();

    const double    TopEJ_xyPlane_Angle = (Scatter_Angle-Dip_Angle)/TMath::Pi()*180.;
    
      
    G4double TopEJ301Center_PositionX = (TMath::Cos(Scatter_Angle)*TMath::Cos(Dip_Angle)+TMath::Sin(Scatter_Angle)*TMath::Sin(Dip_Angle))*(TPC_EJ_Distance + EJ_halfHeight);
    G4double TopEJ301Center_PositionY =  0.;
    G4double TopEJ301Center_PositionZ = (TMath::Sin(Scatter_Angle)*TMath::Cos(Dip_Angle)-TMath::Cos(Scatter_Angle)*TMath::Sin(Dip_Angle))*(TPC_EJ_Distance + EJ_halfHeight)+TPC_Center_zAxis_Offset;
    
    G4double SideEJ301Center_PositionX = TMath::Cos(Dip_Angle)*TMath::Cos(Scatter_Angle)*(TPC_EJ_Distance + EJ_halfHeight);
    G4double SideEJ301Center_PositionY = TMath::Sin(Scatter_Angle)*(TPC_EJ_Distance + EJ_halfHeight);
    G4double SideEJ301Center_PositionZ = -TMath::Sin(Dip_Angle)*TMath::Cos(Scatter_Angle)*(TPC_EJ_Distance + EJ_halfHeight)+TPC_Center_zAxis_Offset;
   
    G4double EJ4Center_PositionX = TMath::Cos(Dip_Angle)*TMath::Cos(EJ4_Scatter_Angle)*(TPC_EJ4_Distance + EJ4_halfHeight);
    G4double EJ4Center_PositionY = -TMath::Sin(EJ4_Scatter_Angle)*(TPC_EJ4_Distance + EJ4_halfHeight);
    G4double EJ4Center_PositionZ = -TMath::Sin(Dip_Angle)*TMath::Cos(EJ4_Scatter_Angle)*(TPC_EJ4_Distance + EJ4_halfHeight)+TPC_Center_zAxis_Offset;

    //std::cout<<"EJ4Center_PositionZ: "<<EJ4Center_PositionZ<<std::endl;

    
    double SideEJ_Theta = TMath::ASin(-SideEJ301Center_PositionZ/TMath::Sqrt(TMath::Power(SideEJ301Center_PositionX, 2)+TMath::Power(SideEJ301Center_PositionY, 2) ) ); //---- the angle between line and xyPlane ----
    double   SideEJ_Phi = TMath::ATan(SideEJ301Center_PositionY/SideEJ301Center_PositionX);//---- projected line, the angle to the xAxis -----
    
    double EJ4_Theta = TMath::ASin(-EJ4Center_PositionZ/TMath::Sqrt(TMath::Power(EJ4Center_PositionX, 2)+TMath::Power(EJ4Center_PositionY, 2) ) ); //---- the angle between line and xyPlane ----
    double   EJ4_Phi = TMath::ATan(EJ4Center_PositionY/EJ4Center_PositionX);//---- projected line, the angle to the xAxis -----
    
    G4double SideEJ_Theta_Angle = SideEJ_Theta/TMath::Pi()*180.;
    G4double   SideEJ_Phi_Angle = SideEJ_Phi/TMath::Pi()*180.;
    G4double    EJ4_Theta_Angle = EJ4_Theta/TMath::Pi()*180.;
    G4double      EJ4_Phi_Angle = EJ4_Phi/TMath::Pi()*180.;

    
    //std::cout<<"SideEJ_Theta: "<<SideEJ_Theta/TMath::Pi()*180.<<" deg"<<std::endl;
    //std::cout<<"SideEJ_Phi: "<<SideEJ_Phi/TMath::Pi()*180.<<" deg"<<std::endl;
    ...
    R_EJ4.rotateX((90-EJ4_Theta_Angle)*deg);
    
    R_EJ2.rotateZ((90-SideEJ_Phi_Angle)*deg);
    R_EJ3.rotateZ((-90+SideEJ_Phi_Angle)*deg);
    R_EJ4.rotateZ((EJ4_Phi_Angle-90)*deg);

    
    T_EJ1.setX(TopEJ301Center_PositionX);
    T_EJ1.setZ(TopEJ301Center_PositionZ);
    
    T_EJ2.setX(SideEJ301Center_PositionX);
    T_EJ2.setY(-SideEJ301Center_PositionY);
    T_EJ2.setZ(SideEJ301Center_PositionZ);
    
    T_EJ3.setX(SideEJ301Center_PositionX);
    T_EJ3.setY(SideEJ301Center_PositionY);
    T_EJ3.setZ(SideEJ301Center_PositionZ);
   
    T_EJ4.setX(EJ4Center_PositionX);
    T_EJ4.setY(EJ4Center_PositionY);
    T_EJ4.setZ(EJ4Center_PositionZ);
     ...
     new G4PVPlacement(G4Transform3D(R_EJ4, T_EJ4),  EJ4_tube_Logical, "EJ301_4", fpWorldLogical, true, 1, true);
    ...
    const G4double     EJ1_Polythene_Shielding_zAxisPos =  EJ1_Shielding_Btm_Ground_Distance-TPC_Center_Ground_Distance+1.5*2.54*cm+PE_Polythene_Shielding_Half_Length+zAxis_OctRun_Offset_Length;
  ...
  Al_Frame_LongBeam_Logic->SetVisAttributes(Al_Color);
    ...
    const G4double    Cutting_Length =     5*2.54*cm;
    ...
    const G4double Front_Pole_Height =  TPC_Center_Ground_Distance+zAxis_TPC_Center_BeamLine_Distance-Front_Pole_Proton_Beam_Distance-Al_Frame_Btm_Ground_Distance-Al_Frame_SideLength - Cutting_Length;
    ...
    ActiveLAr_Volume_Logical->SetSensitiveDetector(monitor);
            ...
            EJ4_tube_Logical->SetSensitiveDetector(monitor);
