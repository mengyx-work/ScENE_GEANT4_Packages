...
Xenon100PhysicsList::Xenon100PhysicsList():G4VUserPhysicsList()
{
...
Xenon100PhysicsList::~Xenon100PhysicsList()
{
}

void
Xenon100PhysicsList::ConstructParticle()
{
	ConstructMyBosons();
	ConstructMyLeptons();
	ConstructMyHadrons();
...
void
Xenon100PhysicsList::ConstructMyBosons()
{
...
void
Xenon100PhysicsList::ConstructMyLeptons()
{
...
void
Xenon100PhysicsList::ConstructMyHadrons()
{
...
void
Xenon100PhysicsList::ConstructMyShortLiveds()
{
}

void
Xenon100PhysicsList::ConstructProcess()
{
	AddTransportation();
	ConstructEM();
	ConstructOp();
...
void
Xenon100PhysicsList::AddTransportation()
{
...
#include "G4hMultipleScattering.hh" // the standard hadron scattering

//em process options to allow msc step-limitation to be switched off
#include "G4EmProcessOptions.hh"

void
Xenon100PhysicsList::ConstructEM()
{
...
void
Xenon100PhysicsList::ConstructOp()
{
...
// newly added for the HadronCapture class
...
void
Xenon100PhysicsList::ConstructHad()
{
...
void
Xenon100PhysicsList::ConstructGeneral()
{
